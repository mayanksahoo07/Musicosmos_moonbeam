			...
			<div className={"create_nft_bg glass_effect glass_effect_border upload-song-div-2 " + (props.smallScreen ? " small-screen-style mt-5" : " small-screen-div-2")}>
				...
				<div className="div1-content">
					...
					<p>
						...
						<Tooltip
							labelText="Know more"
							message={`The background field in Musicosmos helps connect artists with their fans on a deeper level. You can write about the whole ideation process and the journey behind creating this awesome piece of music. Your fans will really be interested in hearing this from you!`}
						/>
					</p>
