	...
	return (
		<div className="create_nft_bg glass_effect glass_effect_border upload_cover_image_div">
			...
			<div className="mt-2">
				...
				/>
				<p>
					Price &nbsp; <Tooltip labelText="Know more" message={`1 DEV = $${props.devUSD} or ₹${props.devINR}`} />
				</p>
				<input
					type="number"
					className="input-text-field"
					placeholder="Enter Price in DEV"
				...
				{/*<div className="on-sale-div mt-3">
					<p>
						...
						<Tooltip
							labelText=""
							message={`Do you want to keep the NFT on the Musicosmos marketplace for sale? If you choose no, then interested buyers will not be able to buy this NFT until you put it back up on the marketplace again.`}
						/>
					</p>
